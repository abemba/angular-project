...
export class IndexComponent implements OnInit {
  ...
  [
    ...
    //{label:"Authorization", "icon":"mdi mdi-shield-account-outline", link:[{ outlets: { 'shared-fund': ['requests'] } }] },
    {label:"Consent", "icon":"mdi mdi-handshake-outline", link:[{ outlets: { 'shared-fund': ['consent'] } }] },
