...
@Component({
  selector: 'app-in-pipe-bank',
  templateUrl: './in-pipe-bank.component.html',
  styleUrls: ['./in-pipe-bank.component.scss']
})
export class InPipeBankComponent implements OnInit {
